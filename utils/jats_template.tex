...
$endif$
$if(citation_suggestion)$
<custom-meta-group>
<custom-meta specific-use="$citationSuggestionLabel$">
<meta-name>citation_suggestion</meta-name>
<meta-value><named-content content-type="citation_suggestion">$citation_suggestion$</named-content></meta-value>
</custom-meta>
</custom-meta-group>
$endif$
</article-meta>
