    ...
    <div id="header">
      ...
      <img alt="" id="journal_logo" src="media/journal_logo.png" height="50px"></img>
        <p><strong>
          ...
          Band <xsl:value-of select="//article-meta/volume"/>,
      ...
      <xsl:for-each select="article-meta | self::front-stub">
        ...
        <div id="article-metadata" style="display: flex;">
          <div style="display: inline-block; width: 50%">
            ...
            <div>
              ...
              <p> <a href="https://doi.org/{$doi}">https://doi.org/<xsl:apply-templates select="article-id[@pub-id-type='doi']"></xsl:apply-templates>
              </a></p>
            </div>
          </div>
        ...
        <xsl:if test="kwd-group">
          <div id="keyword_group_meta" class="metadata">
            <h7 class="callout-title normal"><span class="generated">Schlagwörter: </span></h7>
        ...
        <div id="custom_group_meta" class="metadata">
          <h7 class="callout-title normal"><span class="generated">Zitiervorschlag: </span></h7>
          <span class="generated">
...
<!--        <xsl:text>Date</xsl:text>-->
  ...
  <xsl:template match="xref" mode="metadata-inline">
    ...
    <span class="generated"><sup>[</sup></span>
    <xsl:apply-templates select="."/>
    <span class="generated"><sup>]</sup></span>
  </xsl:template>
  ...
  <xsl:template match="contrib-id[@contrib-id-type='orcid']" mode="metadata-inline">
    ...
    <a href="{$orcid_url}">
      <img alt="ORCID logo" src="https://info.orcid.org/wp-content/uploads/2019/11/orcid_16x16.png" width="16" height="16" ></img>
    </a>
  </xsl:template>
...
<!-- ============================================================= -->
  ...
  <xsl:template match="boxed-text | chem-struct-wrap |
    ...
    <div class="{$gi} panel">
      <xsl:if test="not(@position != 'float')">
        ...
        <!--RS <xsl:attribute name="style">display: float; clear: both</xsl:attribute> -->
      </xsl:if>
      <xsl:call-template name="named-anchor"/>
<!--      <xsl:apply-templates select="." mode="label"/>-->
      <xsl:apply-templates/>
...
<!--      <xsl:apply-templates select="." mode="label"/>-->
  ...
  <xsl:template match="permissions">
    ...
    <xsl:if test="copyright-year | copyright-holder">
      <p class="copyright">
        <span class="generated"><p>Lizenzinformation:</p></span>
        <xsl:for-each select="copyright-year | copyright-holder">
  ...
  <xsl:template match="license-p/graphic">
    ...
    <a href="{$url}" target="_blank"><img alt="" src="./media/ccby.png"></img></a>
    </div>
  </xsl:template>
